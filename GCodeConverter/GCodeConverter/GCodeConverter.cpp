...
ArrayList<Point>* parseLayer(FILE* file, Point* lastPos) {
...
void Convert(string gCodePath, string outputPath) {
	ofstream  outputFile;
	FILE* gCodeFile;
